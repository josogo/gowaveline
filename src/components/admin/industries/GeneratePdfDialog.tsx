...
export const GeneratePdfDialog: React.FC<GeneratePdfDialogProps> = ({ 
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `WaveLine_${industry.name.replace(/\s+/g, '_')}_application.pdf`;
          ...
          <div className="mt-6 flex justify-between">
            <div className="flex p-3 bg-blue-50 border border-blue-200 rounded-lg flex-1 mr-4">
              ...
              <p className="text-sm text-blue-800">
                This form will be used to generate a custom merchant application PDF for {industry.name}. Fill out as many fields as possible for the most complete document.
              </p>
            </div>
            <Button 
